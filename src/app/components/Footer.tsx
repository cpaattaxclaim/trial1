          ...
          <div>
            <h3 className="font-semibold mb-4">Our Services</h3>
                <ul className="space-y-2 text-sm">
                  <li className="text-teal-400 text-xs uppercase tracking-wider mb-1">International</li>
                  <li>
                  ...
                  <li className="text-teal-400 text-xs uppercase tracking-wider mt-3 mb-1">Domestic</li>
                  <li>
