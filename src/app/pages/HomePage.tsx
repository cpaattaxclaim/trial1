...
export function HomePage() {
  ...
  useSEO({
    ...
    schema: {
      ...
      logo: 'https://taxclaim.co/favicon.ico',
      image: 'https://taxclaim.co/favicon.ico',
      priceRange: '$$',
      telephone: '+1 (415) 304-7262',
      description:
        'TaxClaim specializes in US tax compliance for foreign founders and cross-border businesses. Services include Form 5471, FBAR, FATCA, pro forma 1120, and foreign-owned US entity compliance.',
      areaServed: [
        'United States', 'United Kingdom', 'India', 'Singapore',
        'Canada', 'Germany', 'Netherlands', 'UAE', 'China',
      ...
      hasCredential: [
        ...
        },
        {
          ...
          credentialCategory: 'Professional License',
          recognizedBy: { '@type': 'Organization', name: 'Institute of Chartered Accountants of India (ICAI)' },
        },
      ],
      sameAs: [
      ...
      address: {
        '@type': 'PostalAddress',
        streetAddress: '3401 Iron Point Drive',
      ...
      <main>
              ...
              <div>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-teal-300 hover:text-teal-200 transition-colors cursor-pointer"
                  >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  We are not just tax preparers. We are your strategic partners in navigating
                  cross-border compliance and building a solid US tax foundation.
                </p>
        ...
        <section className="py-20 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Whether you have a foreign-owned US entity, need to file Form 5471, or are setting
              up your first US structure, book a free clarity call and we will tell you exactly
              what is required.
            </p>
