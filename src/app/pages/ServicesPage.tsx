            ...
            <div className="space-y-16">
              {services.map((service, idx) => (
                <div
                  key={idx}
                  id={service.id}
                  className={`scroll-mt-24 bg-white border rounded-2xl overflow-hidden hover:shadow-xl transition-shadow ${
                    service.highlight
                ...
                >
                  {service.highlight && (
                    <div className="bg-teal-600 px-8 py-2">
                      <span className="text-white text-sm">International Specialist - Custom Pricing</span>
                    </div>
                  )}
                    ...
                    <div className="md:col-span-2 p-8">
                      ...
                      {service.penaltyNote && (
                        <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                          ...
                          <p className="text-sm text-amber-800">{service.penaltyNote}</p>
                        </div>
                      )}
                        ...
                        <div className="mb-6">
                          ...
                          <div className="space-y-2">
                            {service.tiers.map((tier, i) => (
                              <div key={i} className="flex items-center justify-between bg-slate-50 rounded-lg px-4 py-3 border border-gray-100">
                                <span className="text-gray-700 text-sm">{tier.label}</span>
                                <span className="text-teal-600 text-sm ml-4 whitespace-nowrap">{tier.price}</span>
                              </div>
                            ))}
                          </div>
                        </div>
